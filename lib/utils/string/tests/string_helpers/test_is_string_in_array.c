...
void test_is_string_in_array() {
  ...
  ADD_CASE_TO_STORE(&cases_store, " ", true, " ");
  ADD_CASE_TO_STORE(&cases_store, "", true, "");
  ADD_CASE_TO_STORE(&cases_store, "NULL", true, "abc", "", "NULL");
  ADD_CASE_TO_STORE(&cases_store, "\0", true, "\0");
  ADD_CASE_TO_STORE(&cases_store, "\0", true, "");
  ...
  ADD_CASE_TO_STORE(&cases_store, "NULL", false, "abc", "", "  ");
  ADD_CASE_TO_STORE(&cases_store, "NULL", false, "\0", "", "  ");
  ADD_CASE_TO_STORE(&cases_store, "\0", false, "  ");
